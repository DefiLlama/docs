...
* Excel template: [Stablecoin Yield Finder](../.gitbook/assets/DefiLlama_Stablecoin_Yield_Finder.xlsx)
...
* Excel template: [Multi-Chain Yield Finder with Earnings Calculator](../.gitbook/assets/DefiLlama_Multi-Chain_Yield_Finder__Earnings_Calculator.xlsx)
...
* Excel template: [Protocol Comparison Table](../.gitbook/assets/DefiLlama_Protocol_Comparison.xlsx)
...
* Excel template: [Chain Comparison Table](../.gitbook/assets/DefiLlama_L1_-_L2_Chain_Comparison.xlsx)

{% file src="../.gitbook/assets/DefiLlama_Advanced_Revenue_Table.xlsx" %}
...
* Excel template: [Advanced Revenue Table](../.gitbook/assets/DefiLlama_Advanced_Revenue_Table.xlsx)
